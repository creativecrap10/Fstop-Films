...
const Portfolio = () => {
  const categories = ["All", "MARRIAGE", "PRE | POST WEDDING", "BABY SHOWER", "DRONE AIR", "EVENT", "PRODUCT"];
  ...
  const handlePrevImage = () => {
    ...
    // Video carousel data
    const videos = [
      { id: 1, src: "./video/11.mp4", title: "Video 1" },
      { id: 2, src: "./video/12.mp4", title: "Video 2" },
      { id: 3, src: "./video/13.mp4", title: "Video 3" },
      { id: 4, src: "./video/14.mp4", title: "Video 4" },
    ];
  ...
  return (
    <section id="portfolio" className="section">
      ...
      <div className="heading">
        <h4>Our Gallery</h4>
        <h1>Discoveries by High Skilled</h1>
      </div>
      ...
      <div className="heading">
        <h4>Candid & Still Video</h4>
        <h1>Record your precious moments</h1>
      </div>
